...
\begin{doublespace}
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{3cm}|p{3cm}|X|}
				...
				\textbf{Attribut} & \textbf{Signification} & \textbf{Exemple}                                       \\
				\hline
				NomDelegant       & Nom du délégant        & Etablissement de Coopération Intercommunal  "Al Baida" \\
				\hline
			\end{tabularx}
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{2.5cm}|X|p{2.5cm}|}
				...
				\hline
				valeur\_delegant  & Somme invessti par le délégant                                                                      & 900000 Dhs       \\
				\hline
				abri\_delegant    & Nombre des abris bus de délégant                                                                    & 6                \\
				\hline
				arret\_delegant   & Nombre des arrêts de délégant                                                                       & 7                \\
				\hline
				bus\_delegant     & Nombre des burs de délégant                                                                         & 50               \\
				\hline
				...
				\hline
				valeur\_autre     & Somme invessti par les autres partenaires (autre que le délégants et le délégataire)                & 800000 Dhs       \\
				\hline
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|X|X|p{2.5cm}|}
				...
				\hline
				abris\_bus\_satisfaction                   & Satisfusance des abris bus                 & 76\%             \\
				\hline
				...
				\hline
				arrêts\_satisfaction                       & Satisfusance des arrêts                    & 80\%             \\
				\hline
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{6cm}|X|p{2.5cm}|}
				...
				\hline
				bus\_éléctrique\_nombre           & Nombre des bus éléctriques                       & 10               \\
				\hline
				bus\_éléctrique\_age\_moyen       & Âge moyen des bus éléctriques                    & 10 ans           \\
				\hline
				bus\_éléctrique\_km\_parcourus    & Nombre des Km parcourus des bus éléctriques      & 80000 Km         \\
				\hline
				bus\_sites\_prores\_nombre        & Nombre des bus des sites prores                  & 15               \\
				\hline
				bus\_sites\_prores\_age\_moyen    & Âge moyen des bus des sites prores               & 15 ans           \\
				\hline
				bus\_sites\_prores\_km\_parcourus & Nombre des Km parcourus des bus des sites prores & 70000 Km         \\
				\hline
				datedemiseajour                   & Date de mise à jour                              & 16/04/2021       \\
				\hline
				periode                           & Année/semestre                                   & 2020/S1          \\
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{4cm}|X|p{2.5cm}|}
				...
				\hline
				Equipements\_points\_arrêt & Equipements des points d'arrêt                                                                              & Poteaux          \\
				\hline
				...
				\hline
				AdressedescpSTR            & Site internet et information disponible  en temps réel (Descption d'adresse)                                & oui              \\
				\hline
				ReseauSTR                  & Site internet et information disponible  en temps réel (Informations Statiques sur le réseau)               & oui              \\
				\hline
				ReseaudescpSTR             & Site internet et information disponible  en temps réel (Descption des informations Statiques sur le réseau) & non              \\
				\hline
				HoraireServiceSTR          & Site internet et information disponible  en temps réel (Horaire du services)                                & oui              \\
				\hline
				HoraireServicedescpSTR     & Site internet et information disponible  en temps réel (Descption d'horaire du services)                    & oui              \\
				\hline
				PerturbationsSTR           & Site internet et information disponible  en temps réel (Informations sur les perturbations)                 & oui              \\
				\hline
				PerturbationsdescpSTR      & Site internet et information disponible  en temps réel (Descption des informations sur les perturbations)   & oui              \\
				\hline
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{4cm}|X|p{2cm}|}
				...
				\hline
				Ponctualite       & Ponctualité Ecart moyen entre horaire contractuel et horaire réel & 60\%             \\
				\hline
				...
				\hline
				DélaiEva          & Délai moyes d'évacuation des véhicules en panne                   & 25 min           \\
				\hline
				datedemiseajour   & Date de mise à jour                                               & 16/04/2021       \\
				\hline
				periode           & Année/semestre                                                    & 2020/S1          \\
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{4cm}|X|p{3cm}|}
				...
				\hline
				ConsommationMoyElec & Consommation moyenne par km et par type de bus éléctrique   & 15263 tonnes     \\
				\hline
				ConsommationMoySite & Consommation moyenne par km et par type de bus sites prores & 15263 tonnes     \\
				\hline
				ConsommationAnn     & Consommation carburant annuelle pour l'ensemble du parc     & 152630 tonnes    \\
				\hline
				ConsommationAnnEle  & Consommation totale en electricité annuelle                 & 1526003 Kwh      \\
				\hline
				Emissions           & Emissions Carbone  Co2                                      & 15263 tonnes     \\
				\hline
				datedemiseajour     & Date de mise à jour                                         & 16/04/2021       \\
				\hline
				periode             & Année/semestre                                              & 2020/S1          \\
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabularx}{17.5cm}{|p{4cm}|X|p{2cm}|}
				...
				\hline
				mécanicier             & Nombre des mécaniciers           & 30               \\
				\hline
				personnelAdministratif & Nomve du personnel administratif & 50               \\
				\hline
				datedemiseajour        & Date de mise à jour              & 16/04/2021       \\
				\hline
				periode                & Année/semestre                   & 2020/S1          \\
	...
	\begin{figure}[H]
		\begin{center}
			\fbox{\includegraphics[scale=0.29]{images/MCD.png}}
	...
	\begin{figure}[H]
		\begin{center}
			\fbox{\includegraphics[scale=0.38]{images/database.png}}
			\caption{Le modèle conceptuel des données}
		\end{center}
	\end{figure}
