...
\begin{doublespace}
    ...
    \begin{doublespace}
        ...
        au suivi.
        À titre d'exemple on peut considérer l'application suivante:
        \textbf{\large Jumia:}\\
        ...
        \begin{doublespace}
            ...
            \begin{itemize}
                \item L’administrateur: c'est la personne chargée
                      d'affecter les différents rôles et de
                      gérer les comptes et les produits ainsi que les
                      réclamations.
            ...
            Les besoins fonctionels sont basiques pour un fonctionnement
