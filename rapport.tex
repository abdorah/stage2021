...
\begin{figure}[H]
	\begin{center}
		\fbox{\includegraphics[scale=0.40]{images/patch contrat.jpg}}
...
\begin{figure}[H]
	\begin{center}
		\fbox{\includegraphics[scale=0.40]{images/patch avancement.jpg}}
...
\begin{itemize}
	\item[•] %\textbf{Rapport en \LaTeX:} \url{https://github.com/abdorah/stage2021/blob/master/rapport.tex}
\end{itemize}
